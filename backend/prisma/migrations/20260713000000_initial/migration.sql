...
CREATE TABLE `GeneralSetting` (
    ...
    `academyName` VARCHAR(191) NOT NULL DEFAULT 'Luis Toledo Academy',
    `legalName` VARCHAR(191) NULL,
    `tagline` VARCHAR(191) NULL,
    `supportEmail` VARCHAR(191) NULL,
    `timezone` VARCHAR(191) NOT NULL DEFAULT 'America/Mexico_City',
    `defaultLocale` VARCHAR(191) NOT NULL DEFAULT 'es-MX',
    `defaultCurrency` VARCHAR(191) NOT NULL DEFAULT 'MXN',
